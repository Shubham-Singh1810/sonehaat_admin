...
function TaxList() {
  ...
  const handleGetCategoryFunc = async () => {
    ...
    try {
      let response = await getTaxServ(payload);
  ...
  const handleAddCategoryFunc = async () => {
    setIsLoading(true);
    try {
      let response = await addTaxServ(addFormData);
  ...
  const handleDeleteCategoryFunc = async (id) => {
    ...
    if (confirmed) {
      try {
        let response = await deleteTaxServ(id);
        if (response?.data?.statusCode == "200") {
          toast?.success(response?.data?.message);
          handleGetCategoryFunc();
        }
  ...
  return (
    <div className="bodyContainer">
      <Sidebar selectedMenu="Product Management" selectedItem="Taxes" />
        ...
        <div className="p-lg-4 p-md-3 p-2">
          ...
          <div className="row m-0 p-0 d-flex align-items-center my-4 topActionForm">
            <div className="col-lg-2 mb-2 col-md-12 col-12">
              <h3 className="mb-0 text-bold text-secondary">Taxes</h3>
            </div>
              ...
              <div className="modal-body">
                ...
                >
                  <div className="w-100 px-2">
                    ...
                    />
                    <label className="mt-3">Percentage</label>
                    <input
                      className="form-control"
                      type="number"
                      onChange={(e) =>
