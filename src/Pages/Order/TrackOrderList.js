...
function TrackOrderList() {
  ...
  return (
    <div className="bodyContainer">
      <Sidebar selectedMenu="Orders" selectedItem="Track Orders" />
      <div className="mainContainer">
        ...
        <div className="p-lg-4 p-md-3 p-2">
          ...
          <div className="d-flex justify-content-between mt-4">
            {deliveryStatusArr?.map((v, i) => {
              return (
                <div
                  key={i}
                  className="orderBox d-flex"
                  onClick={() =>
                    setPayload({
                      ...payload,
                      deliveryStatus: v?.value,
                      selectedIndex: i,
                    })
                  }
                >
                  <div
                    className={
                      "statusCircle mb-3 " +
                      (i <= payload.selectedIndex
                        ? "bg-success glowEffect"
                        : "bg-secondary")
                    }
                  ></div>
                  <div>
