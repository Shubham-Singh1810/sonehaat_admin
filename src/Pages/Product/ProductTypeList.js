...
import {
  getProductTypeServ,
  addProductTypeServ,
  updateProductTypeServ,
  deleteProductTypeServ,
...
function ProductTypeList() {
  ...
  const handleGetCategoryFunc = async () => {
    ...
    try {
      let response = await getProductTypeServ(payload);
  ...
  const handleAddCategoryFunc = async () => {
    setIsLoading(true);
    try {
      let response = await addProductTypeServ(addFormData);
  ...
  const handleDeleteCategoryFunc = async (id) => {
    ...
    if (confirmed) {
      try {
        let response = await deleteProductTypeServ(id);
        if (response?.data?.statusCode == "200") {
          toast?.success(response?.data?.message);
          handleGetCategoryFunc();
        }
  ...
  return (
    <div className="bodyContainer">
      <Sidebar selectedMenu="Product Management" selectedItem="Product Types" />
        ...
        <div className="p-lg-4 p-md-3 p-2">
          ...
          <div className="row m-0 p-0 d-flex align-items-center my-4 topActionForm">
            <div className="col-lg-2 mb-2 col-md-12 col-12">
              <h3 className="mb-0 text-bold text-secondary">Product Types</h3>
            </div>
              ...
              <div className="modal-body">
                ...
                >
                  <div className="w-100 px-2">
                    <h5 className="mb-4">Add Product Type</h5>
