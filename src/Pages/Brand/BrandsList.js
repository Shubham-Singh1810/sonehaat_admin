...
function BrandsList() {
  ...
  const handleGetCategoryFunc = async () => {
    ...
    try {
      let response = await getBrandServ(payload);
  ...
  const handleAddCategoryFunc = async () => {
    ...
    try {
      let response = await addBrandServ(formData);
  ...
  const handleDeleteCategoryFunc = async (id) => {
    ...
    if (confirmed) {
      try {
        let response = await deleteBrandServ(id);
        if (response?.data?.statusCode == "200") {
          toast?.success(response?.data?.message);
          handleGetCategoryFunc();
        }
  ...
  const handleUpdateCategoryFunc = async () => {
    ...
    try {
      let response = await updateBrandServ(formData);
      if (response?.data?.statusCode == "200") {
        toast.success(response?.data?.message);
        setEditFormData({
          name: "",
        ...
        <div className="p-lg-4 p-md-3 p-2">
          ...
          <div className="row m-0 p-0 d-flex align-items-center my-4 topActionForm">
            <div className="col-lg-2 mb-2 col-md-12 col-12">
              <h3 className="mb-0 text-bold text-secondary">Brands</h3>
            </div>
                ...
                <table className="table">
                  <tbody>
                    <tr style={{ background: "#F3F3F3", color: "#000" }}>
                      ...
                      <th className="text-center py-3">Brand Name</th>
          ...
          <div className="modal-dialog">
            ...
            >
              ...
              <div className="modal-body">
                ...
                >
                  <div className="w-100 px-2">
                    <h5 className="mb-4">Update Brand</h5>
                    <div className="p-3 border rounded mb-2">
                      <img
